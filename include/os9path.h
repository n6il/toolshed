...
error_code _os9_read(os9_path_id, void *, int *);
...
error_code _os9_readln(os9_path_id, void *, int *);
error_code _os9_write(os9_path_id, void *, int *);
error_code _os9_writeln(os9_path_id, char *, int *);
