...
#define		FNAMESIZE	256		/* file name size */
...
#define		   basictype(t)		((t) & BASICT)
#define		   ispointer(t)		(((t) & XTYPE) == POINTER)
#define		   isarray(t)		(((t) & XTYPE) == ARRAY)
#define		   isfunction(t)	(((t) & XTYPE) == FUNCTION)
