...
struct symblstr {
        ...
        struct symblstr  *left, *right;
        struct ref_str  *wrd;
        char  symblnam[10];      /* Symbol Name */
};

/* Delete this temporarily.. tra to create a structure to hold all
 * of command bytes */
/*union storer1 {
   char C_Byt[4];
...
typedef struct macdescr {
   struct macdescr *LastMac;   /* Address of previous macro descriptor   */
