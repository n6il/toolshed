...
GLOBAL direct FILE *SrcFile,                 /* D0015 */
            *OutFile,                 /* D0017 */
            *PrtPth;
GLOBAL direct int  NumBytes, d001d,
            jsrOfst, d0021, had_err;
GLOBAL direct unsigned d0025, d0027, _If_Dpth, _IfIsTru;
GLOBAL direct unsigned ListPag, ListLin;    /* d002d, d002f */
GLOBAL direct long nmbr_int;
GLOBAL direct unsigned char nmbr_str[8]; /*Little-Endian ordered string*/
GLOBAL direct short d0033;
GLOBAL direct int HadBrkt, HadArrow;
GLOBAL direct int d0039[2];                 /*  ???   */
GLOBAL direct int  doList, IsExtrn, Glbls, dGlbls, edatas, ddatas;
GLOBAL direct unsigned int d0049, *S_Addrs;
GLOBAL direct int CodeSize;
GLOBAL direct unsigned int *Adrs_Ptr;
GLOBAL direct unsigned int d0051, *d0053;
GLOBAL direct short GlobCnt, ref_cnt,         /* D0055, D0057 */
            comn_cnt, locl_cnt;
GLOBAL direct char Pass2,                     /* D005d */
            d005e, d005f, d0060, LblTyp, 
            d0062, d0063;
GLOBAL direct char *SrcChar,           /* d0064 originally */
            *Label, *operatr, *d006a, *oprand,
            *coment;
GLOBAL direct JMPTBL *jmp_ptr;
GLOBAL direct CODFORM *Cod_Ent;
GLOBAL direct CODFORM *CodTbBgn, *CodTbEnd;
GLOBAL direct struct symblstr **d0078,
            *SmblDsc,              /* D007a */
            *d007c;

/*direct char d007e, d007f[7], *d0086[6],
            d0092, d0093[7], *d009a[6],
            d00a6, d00a7[7], *d00ae[6];*/
...
GLOBAL direct char C_Flg, ff_flg, g_flg, d00c4,
            ListFlg, listON, d00c7,
            OFlg, S_Flg,R_Keep;                /* D00c8, D00c9 */
...
GLOBAL struct symblstr *d068f[128],
                *d078f;
GLOBAL struct ref_ent d0791[10], *OptBPtr;
GLOBAL struct symblstr **d07b1;

#include "rtables.h"

GLOBAL long RofHdLoc, d07b7, d07bb, d07bf;
...
#endif
;
GLOBAL direct FILE *macfp1, *macfp2;        /* d00dc, d00de */
