...
/*extern direct int  NumBytes, doList, Glbls, dGlbls,
                   edatas, ddatas, InMacro;
extern direct char *CmdCod, AIMFlg;
extern direct short d0033;

extern direct char     *Rmb_Ptr, *S_Rmbend, *Nam_Ptr, *Cod_End,
                       C_Flg, *_If_Dpth, *_IfIsTru, *d002d;
extern direct long nmbr_int;
extern direct char     *d0049, **S_Addrs, *CodeSize, **Adrs_Ptr,
                       *d0053, Pass2, d005e, MLCod.prebyte,
                       d0060, d0062, d0063, *SrcChar, *Label, *d006a,
                       *CodTbBgn, *CodTbEnd, *d007c, MLCod.opcode;
extern direct struct symblstr d007e;
...
extern direct JMPTBL *jmp_ptr;
extern JMPTBL CnstTbl[], d03b6[], _if_tbl[];
              ...
              /* aim, oim, tim, eim  */
{
 ...
 char acod = MLCod.opcode,
   ...
   AIMFlg = 1;
   if ( cc_stuff() ) {              /* first, get memory byte */
      if ( *SrcChar == ',' ) {
         ++SrcChar;
