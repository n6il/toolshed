...
/*
 * extern direct char *d006a; extern char *d0681;
 */

/*
 * FindCmd - parses one of the CODFORM lists for a match of a ccmd returns:
 * address of cmd if found, NULL if no match
 */
